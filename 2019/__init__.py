...
def compiles():
    ...
    check50.c.compile("programa.cpp", cc="clang++", std="c++11", lcs50=True, Wall=True, Wextra=True, ggdb3=True)    
...
def runCPP():
    ...
    check50.run("./programa").stdin("foo").stdout("blah").exit(timeout=60)
